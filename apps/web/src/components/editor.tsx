...
import { useEditor, type JSONContent, EditorContent } from "@tiptap/react";
...
export const RichTextEditor = ({
  ...
  return (
    <div
      className={`relative ${
        !readOnly && "outline rounded-xl overflow-hidden"
      }`}
    >
      {!readOnly && (
        <BubbleMenu
      ...
      <EditorContent
        ...
        className={`prose prose-slate dark:prose-invert max-w-none ${
          readOnly
            ? ""
            : "p-4 min-h-[30dvh] rounded-xl overflow-y-scroll max-h-[60dvh]"

...
export default function ErrorBoundary({
  ...
  return (
    <div className="min-h-[92dvh] flex flex-col items-center justify-center gap-8 w-full text-center pt-48">
      ...
      <div className="mt-48 text-sm opacity-30 underline underline-offset-4 break-words cursor-not-allowed">
